...
class Policy(object):
    ...
    def __init__(self, obs_dim, act_dim, kl_targ, load):
        """
        Args:
    ...
    #uncomment following if you want to read from file
    #def load_model(self):
    #    filename='./policy_model/model.ckpt'
    ...
    def _init_session(self):
        ...
        if self.load:
            self.filename='/home/leegroup/Documents/gan_imitation/trpo/src/DATA/Walker_Forward/policy_model/model.ckpt'
            self.saver.restore(self.sess, self.filename)
            print("Model loaded from file: %s" % self.filename)
        else:
            self.filename='/home/leegroup/Documents/gan_imitation/trpo/src/policy_model/model.ckpt'
            self.sess.run(self.init)
            save_path = self.saver.save(self.sess, self.filename)
            print("Policy Model saved in file: %s" % self.filename)
    ...
    def save_model(self):
        save_path = self.saver.save(self.sess, self.filename)
        print("Value Model saved in file: %s" % self.filename)
