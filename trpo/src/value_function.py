...
class NNValueFunction(object):
    ...
    def __init__(self, obs_dim, load):
        """
        Args:
    ...
    #Uncomment following if you want to read from model

    #def load_model(self):
    #    filename='./value_function_model/model.ckpt'
    ...
    def _build_graph(self):
        ...
        self.sess = tf.Session(graph=self.g)
        if self.load:
            self.filename='/home/leegroup/Documents/gan_imitation/trpo/src/DATA/Walker_Forward/value_function_model/model.ckpt'
            self.saver.restore(self.sess, self.filename)
            print("Model loaded from file: %s" % self.filename)
        else:
            self.filename='/home/leegroup/Documents/gan_imitation/trpo/src/value_function_model/model.ckpt'
            self.sess.run(self.init)
    ...
    '''
    def save_model(self,graph = self.g):
        filename='./value_function_model/model.ckpt'
        saver = tf.train.Saver()
